...
export interface ERC2771RecipientContract
  extends Truffle.Contract<ERC2771RecipientInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ERC2771RecipientInstance>;
}

type AllEvents = never;

export interface ERC2771RecipientInstance extends Truffle.ContractInstance {
  /**
